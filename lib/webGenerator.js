...
/* ===== 내용 슬라이드 ===== */
.slide-content{padding:50px 100px;justify-content:flex-start;position:relative;overflow:visible}
.slide-content::before{
  content:'';position:absolute;top:0;left:0;width:100%;height:5px;
  background:linear-gradient(90deg,var(--primary),var(--accent),var(--gradient-to));
}
.slide-content h2{
  font-size:clamp(2rem,3.5vw,3rem);font-weight:800;margin-bottom:8px;
  color:var(--primary);
...
.slide-content .title-line{
  width:60px;height:4px;background:linear-gradient(90deg,var(--primary),var(--accent));margin-bottom:36px;border-radius:2px;
}
...
.bullet-list li{
  ...
  font-size:clamp(1.2rem,2vw,1.75rem);line-height:1.6;
...
.card h3{
  font-size:clamp(1.2rem,1.8vw,1.6rem);color:var(--primary);
  margin-bottom:14px;font-weight:700;position:relative;z-index:1;
}
.card p,.card li{
  font-size:clamp(1.05rem,1.4vw,1.3rem);line-height:1.7;opacity:0.9;
...
.step-body h4{
  font-size:clamp(1.2rem,1.8vw,1.6rem);font-weight:700;margin-bottom:6px;
}
.step-body p{
  font-size:clamp(1.05rem,1.4vw,1.25rem);opacity:0.75;
}

/* ===== 목차 인터랙티브 ===== */
.toc-container{display:flex;flex-direction:column;gap:8px;flex:1;justify-content:center}
.toc-item{
...
.toc-title{font-size:clamp(1.1rem,1.7vw,1.5rem);font-weight:600}
