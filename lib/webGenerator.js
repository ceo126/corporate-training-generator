...
function showSlide(idx){
  ...
  // 내부 애니메이션 요소 리셋
  target.querySelectorAll('.bullet-list li,.card,.step,.stat-item,.col,.tl-item,.checklist li,.quote-mark,.quote-text,.quote-author,.progress-item,.pyramid-level,.ig-item').forEach(el=>{
