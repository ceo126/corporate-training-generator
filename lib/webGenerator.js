...
/* ===== 애니메이션 안전장치: 1.2초 후 강제 가시화 ===== */
.slide.active.anim-done .bullet-list li,
.slide.active.anim-done .card,
.slide.active.anim-done .step,
.slide.active.anim-done .stat-item,
.slide.active.anim-done .col,
.slide.active.anim-done .tl-item,
.slide.active.anim-done .checklist li,
.slide.active.anim-done .quote-mark,
.slide.active.anim-done .quote-text,
.slide.active.anim-done .quote-author,
.slide.active.anim-done .progress-item,
.slide.active.anim-done .pyramid-level,
.slide.active.anim-done .ig-item,
.slide.active.anim-done .donut-item,
.slide.active.anim-done .matrix-cell,
.slide.active.anim-done .cycle-node,
.slide.active.anim-done .chevron,
.slide.active.anim-done .bar-item,
.slide.active.anim-done .hl-icon,
.slide.active.anim-done .hl-main,
.slide.active.anim-done .hl-sub,
.slide.active.anim-done .swot-cell,
.slide.active.anim-done .rm-phase,
.slide.active.anim-done .comp-side,
.slide.active.anim-done .funnel-stage,
.slide.active.anim-done .toc-item,
.slide.active.anim-done .styled-table,
.slide.active.anim-done .agenda-item,
.slide.active.anim-done .image-text-left,
.slide.active.anim-done .image-text-right,
.slide.active.anim-done .typewriter-text,
.slide.active.anim-done h2,
.slide.active.anim-done .section-num,
.slide.active.anim-done .section-desc,
.slide.active.anim-done .title-line,
.slide.active.anim-done .accent-line,
.slide.active.anim-done .subtitle,
.slide.active.anim-done .presenter{
  opacity:1!important;transform:none!important;
}
.slide.active.anim-done .typewriter-text{width:100%!important}
...
function showSlide(idx,fromBroadcast){
  slides.forEach((s,i)=>{
    s.classList.remove('active','prev','anim-done');
